...
/**
 * This class stores a pair of double (decimal) values and contains methods for 
 * reduction to the correct range and for chain limiting.  It is used to store 
 * and process the values that will become the motors' speeds.
 *
 * @author Gil
 */
