...
/**
 * This class stores a quadruple of double values and contains methods for 
 * reduction to the correct range and for chain limiting. This is used for a 
 * four wheel drive or mecanum/omni system.
 *
 * @author Gil
 */
public class SpeedQuadruple implements SpeedSet
{
     ...
     * @param BR
     */
    public SpeedQuadruple(double FL, double FR, double BL, double BR) {
