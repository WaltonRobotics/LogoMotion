...
public class RobotMain extends IterativeRobot {
    ...
    private TwoMotorDrive robotDrive;//a two motor drive
    ...
    public void robotInit() {
        ...
        getLeftEncoder().setDistancePerPulse(8.0 * 3.14 / 360.0);
        setRightEncoder(new Encoder(4, 5));
        //divide by 2 for actual robot
        getRightEncoder().setDistancePerPulse(8.0 * 3.14 / 360.0);
        ...
        setSensors(new SensorSet(gyroChannel,accSlot, usingCamera,
         ...
         sensors.tuneGyro();
         printToScreen("Tuning done.  Gyro drifted " + sensors. getGyroDriftPerSecond() + " degrees per second.");
    ...
    private void handleArmInput() {
        ...
        if (liftJoystick.getRawButton(11)) {
            printToScreen(1,""+sensors.theCamera.blueSeen());
        }
